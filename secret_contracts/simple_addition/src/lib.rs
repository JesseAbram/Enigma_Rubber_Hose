...
impl Contract {
    ...
    fn store_dummy(message: String) {
        ...
        let mut dummy_messages = get_all_dummy_messages();
    ...
    fn store_secrets(accessor: H160, message: String) {
        ...
        // let owner: H160 = read_state!(OWNER).unwrap()
        // assert_eq!(owner, sender)
        let mut secret_messages = get_all_secret_messages();
...
pub trait ContractInterface{
    ...
    // pass in both password and message because front end does not know which store to call
    // only contract knows
    // TODO!!!
